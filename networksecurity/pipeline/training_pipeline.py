...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"Data ingestion artifct: {data_ingestion_artifact}")
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact):
        try:
            ...
            logging.info(f"Data validation artifct: {data_validation_artifact}")
    ...
    def start_data_transformation(self, data_validation_artifact: DataValidationArtifact):
        try:
            ...
            logging.info(f"Data transformation artifct: {data_transformation_artifact}")
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransformationArtifact):
        try:
            ...
            logging.info(f"Model trainier artifct: {model_trainer_artifact}")
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            aws_bucket_url = f"s3://{TRAINING_BUCKET_NAME}/artiact/{self.training_pipeline_config.timestamp}"
